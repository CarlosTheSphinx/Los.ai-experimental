...
export default function RegisterPage() {
  ...
  const accountTypes = [
    {
      id: 'lender',
      title: "I'm a Lender",
      subtitle: 'Automate your loan pipeline',
      icon: Building2,
    },
    {
      id: 'broker',
      title: "I'm a Broker",
      subtitle: 'Submit and track deals',
      icon: Handshake,
    },
    {
      id: 'borrower',
      title: "I'm a Borrower",
      subtitle: 'Track your loan status',
      icon: User,
    },
  ];
  ...
  return (
    <div className="min-h-screen flex bg-background">
      ...
      {/* Right Panel - Account Type Selection + Form */}
        ...
        <div className="w-full max-w-md mx-auto">
          ...
          {!selectedAccountType ? (
            ...
            >
              ...
              <p className="text-muted-foreground mb-8">What best describes you?</p>
                  ...
                  return (
                    <motion.button
                      ...
                      onClick={() => {
                        ...
                        form.setValue('userType', type.id as any);
                      }}
                      whileHover={{ scale: 1.02, y: -2 }}
                      whileTap={{ scale: 0.98 }}
                      className="w-full p-4 rounded-lg border-2 border-border bg-card hover:border-primary hover:shadow-md transition-all text-left"
            ...
            >
              <button
                ...
                className="text-sm text-muted-foreground hover:text-foreground mb-6 font-medium"
              >
                ← Back
              </button>
