        ...
        <div className="px-4 md:px-6 py-3 md:py-4">
          <div className="flex items-center gap-2 md:gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs md:text-sm text-slate-500 hidden sm:block" data-testid="text-page-subtitle">Review and accept your loan quotes</p>
            </div>
          </div>
        </div>
      </header>
        ...
        {isLoading ? (
          ...
          <Card className="text-center py-12" data-testid="empty-state">
            <CardContent>
              ...
              <h3 className="text-xl font-semibold text-slate-600 mb-2">No Quotes Yet</h3>
              <p className="text-slate-400">You don't have any saved quotes. Once a quote is generated for you, it will appear here.</p>
            </CardContent>
          </Card>
        ) : (
                ...
                <Card key={quote.id} className="overflow-visible" data-testid={`card-quote-${quote.id}`}>
                    ...
                    <div className="flex items-start md:items-center justify-between gap-3 flex-wrap">
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        <div className="text-right">
                          <div className="text-xs text-slate-400 flex items-center gap-1" data-testid={`text-date-${quote.id}`}>
                  ...
                  <CardContent className="p-4 md:p-5">
                    <div className="grid grid-cols-2 gap-3 md:gap-4 mb-4">
                      ...
                      <div>
                        <div className="text-xs text-slate-400 uppercase tracking-wide">Date Saved</div>
                        <div className="font-semibold text-sm" data-testid={`text-date-saved-${quote.id}`}>{createdAt}</div>
                      </div>
                    </div>

                    <div className="bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800 rounded-md p-4 mb-4" data-testid={`box-estimated-fees-${quote.id}`}>
                      <div className="flex items-center gap-2 mb-1">
                        <DollarSign className="w-4 h-4 text-blue-600" />
                        <span className="text-sm font-medium text-blue-700 dark:text-blue-300">Total Estimated Fees</span>
                      </div>
                      <div className="text-2xl font-bold text-blue-800 dark:text-blue-200" data-testid={`text-estimated-fees-${quote.id}`}>
                    ...
                    {isRTLQuote && (
                      <div className="bg-slate-50 rounded-md p-4 border border-slate-100 mb-4">
                    ...
                    <div className="flex items-center gap-3 flex-wrap">
                      ...
                      <Button
                        ...
                        className="text-red-500 hover-elevate"
